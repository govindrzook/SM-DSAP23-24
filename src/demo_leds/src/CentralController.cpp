...
public:
  ...
  : Node("central_controller")
  {
	...
	pub1_ = create_publisher<std_msgs::msg::Double>("frontRightSteerPosition", 10);
    pub2_ = create_publisher<std_msgs::msg::Double>("frontRightBrakePosition", 10);
...
private:
	...
	void timer_callback()
  {
    ...
    auto msg = std_msgs::msg::Double();
	auto msg1 = std_msgs::msg::Double();
 ...
 void gz_callback(const std_msgs::msg::String & msg) const
  ...
  void front_right_speed_callback(const std_msgs::msg::String & msg) const
  {
	...
	rclcpp::Publisher<std_msgs::msg::Double>::SharedPtr pub1_;
	rclcpp::Publisher<std_msgs::msg::Double>::SharedPtr pub2_;
